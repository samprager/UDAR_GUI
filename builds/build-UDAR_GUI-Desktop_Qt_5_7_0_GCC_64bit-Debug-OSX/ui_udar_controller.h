...
public:
    ...
    void setupUi(QMainWindow *UDAR_Controller)
    {
        ...
        minFreq_dSpinBox->setGeometry(QRect(564, 20, 101, 24));
        ...
        chirpPRF_dSpinBox->setGeometry(QRect(346, 22, 111, 24));
        ...
        chirpBW_dSpinBox->setGeometry(QRect(564, 70, 101, 24));
        ...
        phaseAccLen_spinBox->setGeometry(QRect(176, 22, 71, 24));
        ...
        chirpTuningWord_spinBox->setGeometry(QRect(146, 72, 81, 24));
        ...
        tabWidget_c->setGeometry(QRect(0, 340, 831, 351));
        tab_c1 = new QWidget();
        ...
        transcript->setGeometry(QRect(0, 10, 451, 309));
        ...
        killThread = new QPushButton(tab_c1);
        ...
        testButton->setGeometry(QRect(700, 120, 113, 32));
        ...
        horizontalScrollBarQ->setGeometry(QRect(0, 308, 811, 16));
        ...
        horizontalScrollBarI->setGeometry(QRect(0, 308, 811, 16));
        ...
        horizontalScrollBarC->setGeometry(QRect(0, 308, 811, 16));
        ...
        horizontalScrollBarFFTI->setGeometry(QRect(0, 308, 811, 16));
        ...
        horizontalScrollBarFFTQ->setGeometry(QRect(0, 308, 811, 16));
        ...
        tabWidget_b->setGeometry(QRect(-2, 154, 831, 185));
        tab_b1 = new QWidget();
        tab_b1->setObjectName(QStringLiteral("tab_b1"));
        srcMacAddr = new QLineEdit(tab_b1);
        srcMacAddr->setObjectName(QStringLiteral("srcMacAddr"));
        srcMacAddr->setGeometry(QRect(480, 26, 107, 21));
        label_2 = new QLabel(tab_b1);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(480, 6, 71, 21));
        srcIpAddr = new QLineEdit(tab_b1);
        srcIpAddr->setObjectName(QStringLiteral("srcIpAddr"));
        srcIpAddr->setGeometry(QRect(480, 66, 107, 21));
        destIpAddr = new QLineEdit(tab_b1);
        destIpAddr->setObjectName(QStringLiteral("destIpAddr"));
        destIpAddr->setGeometry(QRect(340, 64, 113, 21));
        label = new QLabel(tab_b1);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(340, 6, 101, 20));
        label_4 = new QLabel(tab_b1);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(476, 48, 59, 16));
        label_3 = new QLabel(tab_b1);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(340, 46, 59, 16));
        destMacAddr = new QLineEdit(tab_b1);
        destMacAddr->setObjectName(QStringLiteral("destMacAddr"));
        destMacAddr->setGeometry(QRect(340, 26, 113, 21));
        label_5 = new QLabel(tab_b1);
        label_5->setObjectName(QStringLiteral("label_5"));
        label_5->setGeometry(QRect(10, 8, 81, 16));
        writeButton = new QPushButton(tab_b1);
        writeButton->setObjectName(QStringLiteral("writeButton"));
        writeButton->setGeometry(QRect(120, 24, 117, 32));
        listenButton = new QPushButton(tab_b1);
        listenButton->setObjectName(QStringLiteral("listenButton"));
        listenButton->setGeometry(QRect(4, 56, 101, 32));
        byteReorderCheckBox = new QCheckBox(tab_b1);
        byteReorderCheckBox->setObjectName(QStringLiteral("byteReorderCheckBox"));
        byteReorderCheckBox->setGeometry(QRect(126, 84, 101, 20));
        networkInterfaces = new QComboBox(tab_b1);
        networkInterfaces->setObjectName(QStringLiteral("networkInterfaces"));
        networkInterfaces->setGeometry(QRect(10, 28, 104, 26));
        pktRecordCheckBox = new QCheckBox(tab_b1);
        pktRecordCheckBox->setObjectName(QStringLiteral("pktRecordCheckBox"));
        pktRecordCheckBox->setGeometry(QRect(4, 106, 101, 20));
        label_22 = new QLabel(tab_b1);
        label_22->setObjectName(QStringLiteral("label_22"));
        label_22->setGeometry(QRect(482, 102, 81, 16));
        recOutputDirectory = new QLineEdit(tab_b1);
        recOutputDirectory->setObjectName(QStringLiteral("recOutputDirectory"));
        recOutputDirectory->setGeometry(QRect(482, 122, 221, 21));
        label_23 = new QLabel(tab_b1);
        label_23->setObjectName(QStringLiteral("label_23"));
        label_23->setGeometry(QRect(336, 104, 81, 16));
        recOutputFilename = new QLineEdit(tab_b1);
        recOutputFilename->setObjectName(QStringLiteral("recOutputFilename"));
        recOutputFilename->setGeometry(QRect(336, 124, 135, 21));
        label_24 = new QLabel(tab_b1);
        label_24->setObjectName(QStringLiteral("label_24"));
        label_24->setGeometry(QRect(264, 102, 71, 16));
        writeLimit_spinBox = new QSpinBox(tab_b1);
        writeLimit_spinBox->setObjectName(QStringLiteral("writeLimit_spinBox"));
        writeLimit_spinBox->setGeometry(QRect(264, 122, 61, 24));
        writeLimit_spinBox->setMaximum(999999);
        writeLimit_spinBox->setValue(10000);
        promiscModeCheckBox = new QCheckBox(tab_b1);
        promiscModeCheckBox->setObjectName(QStringLiteral("promiscModeCheckBox"));
        promiscModeCheckBox->setGeometry(QRect(4, 84, 113, 20));
        plotOutputButton = new QPushButton(tab_b1);
        plotOutputButton->setObjectName(QStringLiteral("plotOutputButton"));
        plotOutputButton->setGeometry(QRect(720, 116, 87, 32));
        appendInterfaceCheckBox = new QCheckBox(tab_b1);
        appendInterfaceCheckBox->setObjectName(QStringLiteral("appendInterfaceCheckBox"));
        appendInterfaceCheckBox->setGeometry(QRect(4, 130, 115, 20));
        appendInterfaceCheckBox->setChecked(true);
        injectChirp_radioButton = new QRadioButton(tab_b1);
        ...
        injectChirp_radioButton->setGeometry(QRect(126, 62, 51, 20));
        injectChirp_radioButton->setChecked(true);
        injectFmc150_radioButton = new QRadioButton(tab_b1);
        ...
        injectFmc150_radioButton->setGeometry(QRect(180, 62, 65, 20));
        injectFmc150_radioButton->setChecked(false);
        injectReadCmd_radioButton = new QRadioButton(tab_b1);
        ...
        injectReadCmd_radioButton->setGeometry(QRect(236, 40, 83, 20));
        injectReadCmd_radioButton->setChecked(false);
        injectWriteCmd_radioButton = new QRadioButton(tab_b1);
        ...
        injectWriteCmd_radioButton->setGeometry(QRect(238, 12, 85, 20));
        injectWriteCmd_radioButton->setChecked(true);
        tabWidget_b->addTab(tab_b1, QString());
        tab_b2 = new QWidget();
    ...
    void retranslateUi(QMainWindow *UDAR_Controller)
    {
        ...
        tabWidget_a->setTabText(tabWidget_a->indexOf(tab_a1), QApplication::translate("UDAR_Controller", "Chirp", 0));
        ...
        tabWidget_a->setTabText(tabWidget_a->indexOf(tab_a2), QApplication::translate("UDAR_Controller", "FMC150", 0));
        ...
        plotOutputButton->setText(QApplication::translate("UDAR_Controller", "Plot", 0));
        appendInterfaceCheckBox->setText(QApplication::translate("UDAR_Controller", "Append interface", 0));
        injectChirp_radioButton->setText(QApplication::translate("UDAR_Controller", "Chirp", 0));
        injectFmc150_radioButton->setText(QApplication::translate("UDAR_Controller", "FMC150", 0));
        ...
        tabWidget_b->setTabText(tabWidget_b->indexOf(tab_b1), QApplication::translate("UDAR_Controller", "Network", 0));
